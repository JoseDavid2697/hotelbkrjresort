   ...
   <section id="services" class="services">
    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>De igual manera <strong>nuestras habitaciones</strong> estan equipadas con todo lo necesario para una excelente estadia.</h2>
          </div>
          ...
          <div class="col-lg-7 ml-auto" data-aos="fade-left" data-aos-delay="100">
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <figure>
                  <img src="../public/assets/img/features-1.jpg" alt="" class="img-fluid">
                </figure>
              </div>
              <div class="tab-pane" id="tab-2">
                <figure>
                  <img src="../public/assets/img/features-2.jpg" alt="" class="img-fluid">
                </figure>
              </div>
              <div class="tab-pane" id="tab-3">
                <figure>
                  <img src="../public/assets/img/features-3.jpg" alt="" class="img-fluid">
                </figure>
              </div>
              <div class="tab-pane" id="tab-4">
                <figure>
                  <img src="../public/assets/img/features-4.jpg" alt="" class="img-fluid">
                </figure>
              </div>
            </div>
          </div>
